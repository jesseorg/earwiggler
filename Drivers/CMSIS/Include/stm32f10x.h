...
/*************************************************************************************
 If the developer needs to enable the runtime parameter checking mechanism of the standard library, define STDPERIPH_DRIVER_USE_ASSERT in the macro definition options of the compiler
 If the developer does not want to enable the runtime parameter checking mechanism of the standard library, STDPERIPH_DRIVER_USE_ASSERT is not defined

 Tip: Enabling the runtime parameter checking mechanism of the standard library causes the parameter checking code to be executed at runtime, which affects the execution efficiency of library functions and the volume of the generated hex file.
 It is recommended to enable the runtime parameter checking mechanism of the standard library during development, and not to enable it during release.
*/
